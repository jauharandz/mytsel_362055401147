...
import 'package:mytsel/controllers/home_controller.dart';
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ItemKategori(
                                    title: "Telpon",
                                    icon: "assets/images/telepon.png",
                                  ),
                                  ItemKategori(
                                    title: "SMS",
                                  ...
                                  ItemKategori(
                                    title: "Roaming",
                                    icon: "assets/images/roaming.png",
                                  ),
                                ],
                              ),
                              SizedBox(height: 30),
                              Row(
                                ...
                                children: [
                                  ...
                                  ItemKategori(
                                    title: "Unggulan",
                                    icon: "assets/images/unggulan.png",
                                  ),
                                  ItemKategori(
                                    title: "Tersimpan",
                                    icon: "assets/images/tersimpan.png",
                                  ),
                                  ItemKategori(
                                    title: "Riwayat",
                                    icon: "assets/images/riwayattt.png",
                                  ),
                                ],
                              ),
                              SizedBox(height: 30),
    ...
    return Column(
      ...
      children: [
        Container(
          height: 30,
          child: Image.asset(
            (status == true) ? "assets/images/$icon-active.png" : "assets/images/$icon.png",
            fit: BoxFit.contain,
          ),
        ),
        SizedBox(height: 5),
